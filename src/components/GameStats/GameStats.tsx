    ...
    return (
      <div className="game-stats__item multiplier">
       {[1,2,3,4].map((e,i) => {
          ...
          :<span className="multiplier__item multiplier__item_filled" key={i}></span>
        })}
         <span className="game-stats__value">x{multiplier ? multiplier : '0'}</span>
      </div>
  ...
  return (
    <div className='game-stats'>
      <div className="game-stats__item game-stats__timer">
        ...
        <span className="game-stats__value">{timer ? `00:${timer >= 10 ? timer : '0'+timer}` : '00:00'}</span>
      </div>
